...
function Animal (name, legs) {
    ...
    this.identify = function() {
        return "I am a " + name + "with " + legs + " legs.";
    };
}
function Zoo (animals) {
    this.animals = animals;

    this.bipeds = function() {
      var bipedArray = [] ;
...
var tolland = new Zoo(animals);
assert(
  tolland.bipeds().length === 3, "the Zoo should have 3 bipeds"
);
assert(
  tolland.quadrupeds().length === 2, "the Zoo should have 2 bipeds"
);
assert(
